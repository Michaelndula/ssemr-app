...
import { moduleName } from './config/constant';
import { createDashboardLink } from './components/nav/DashboardLink';
import { dashboardMeta } from './config/dashboard.meta';
import RootComponent from './root.component';

const options = {
  featureName: 'esm-ssemr-app',
  moduleName,
};
...
export const SSEMRDashboardLink = getSyncLifecycle(createDashboardLink(dashboardMeta), options);